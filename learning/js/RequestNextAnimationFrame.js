window.requestNextAnimationFrame = 
	(function(){
		...
		// Workaround for Gecko 2.0, witch has a bug in mozRequestAnimationFrame() that restricts animations to 30-40 fps.
		if(window.mozRequestAnimationFrame){
			// Check the Gecko version. 
			// Gecko is used by browsers other than FireFox.
